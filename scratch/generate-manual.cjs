...
<div class="page-container">
  ...
  <section class="cover-page">
    ...
    <div class="meta">
      ...
      <p><strong>Dipersembahkan oleh:</strong></p>
      <p style="color: white; font-weight: 700; font-size: 11pt; margin: 4px 0;">PT Subaga Digital Kreatif</p>
      <p>Talavera Office Park, 28th Floor<br>
      Jl. T. B. Simatupang Kav. 22–26, Cilandak Barat, Jakarta Selatan 12430<br>
  ...
  <section class="avoid-break" style="margin-top: 30px;">
    <h2 style="margin-top: 0;">Informasi Pengendalian Dokumen</h2>
    <table>
      ...
      <tr><td><strong>Penyusun</strong></td><td>Senior Technical Writer & Tim QA PT Subaga Digital Kreatif</td></tr>
      <tr><td><strong>Peninjau / Approval</strong></td><td>Head of Engineering & Principal Solution Architect</td></tr>
      <tr><td><strong>Status</strong></td><td>Approved & Released</td></tr>
  ...
  <section id="pendahuluan">
    ...
    <p>
      <strong>SDK Orchestration Hub</strong> adalah sistem platform enterprise yang dirancang khusus oleh <strong>PT Subaga Digital Kreatif (SDK)</strong> untuk menyatukan seluruh siklus hidup proyek teknologi ke dalam satu ekosistem terpadu. Sebelum adanya platform ini, koordinasi antar divisi sering mengalami kendala fragmentasi informasi akibat penggunaan tools pihak ketiga yang terpisah-pisah untuk kanban, pencatatan waktu, pelaporan klien, dan penyimpanan dokumen.
    </p>
    <p>
      Melalui SDK Orchestration Hub v2.5, seluruh proses mulai dari inisiasi kontrak, pemetaan alur kerja teknis, monitoring beban kerja insinyur, pencatatan jam kerja presisi, hingga interaksi langsung dengan klien berlangsung secara sinkron dan transparan berbasis data cloud real-time.
    </p>
  ...
  <section style="page-break-before: always; min-height: 240mm; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 60px 40px;">
    ...
    <p style="font-size: 13pt; color: #475569; max-width: 620px; margin: 15px auto 35px; line-height: 1.6;">
      Terima kasih telah mempercayai <strong>SDK Orchestration Hub</strong> sebagai fondasi orkestrasi proyek teknologi dan kolaborasi bisnis Anda.
    </p>

    <div style="border-top: 2px solid #e2e8f0; width: 140px; margin: 20px auto;"></div>

    <p style="font-size: 11pt; color: #64748B; margin-top: 30px; line-height: 1.8;">
