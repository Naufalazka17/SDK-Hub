...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* HEADINGS - EVERY CHAPTER AND SUBSECTION TITLE STARTS AT BEGINNING OF PAGE */
    section[id] {
      page-break-before: always;
      break-before: page;
    }
...
<div class="page-container">
  ...
  <!-- ============================================= -->
  <section id="doc-control" style="page-break-before: always; break-before: page; padding-top: 10px;">
    ...
    <div class="callout warning">
      <strong>PERINGATAN: DOKUMEN TERTUTUP (CONFIDENTIAL & PROPRIETARY)</strong>
  ...
  <!-- DAFTAR ISI -->
  <!-- ============================================= -->
  <section class="toc" id="daftar-isi" style="page-break-before: always; break-before: page; padding-top: 10px;">
  ...
  <section id="pendahuluan">
    ...
    <div class="feature-card">
      <h4>3. Resource & Timeline Orchestrator</h4>
    ...
    <div class="callout tip">
      <strong>Catatan Teknis: Portabilitas PWA (Progressive Web App)</strong>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td style="text-align: center; color: #94A3B8;">Dibatasi</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="text-align: center;">Penuh</td>
          <td style="text-align: center;">Penuh</td>
          <td style="text-align: center;">Lihat Saja</td>
          <td style="text-align: center; color: #94A3B8;">Dibatasi</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="text-align: center;">Gunakan Template</td>
          <td style="text-align: center; color: #94A3B8;">Dibatasi</td>
          <td style="text-align: center; color: #94A3B8;">Dibatasi</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="text-align: center;">Penuh</td>
          <td style="text-align: center;">Proyek Terkait</td>
          <td style="text-align: center; color: #94A3B8;">Dibatasi</td>
          <td style="text-align: center; color: #94A3B8;">Dibatasi</td>
        </tr>
        <tr>
  ...
  <section id="admin">
    ...
    <div class="callout warning">
      <strong>Perhatian: Penandaan Tugas Terhambat (Is Blocked)</strong>
  ...
  <section id="staff">
    ...
    <div class="callout note">
      <strong>Ketentuan: Kepatuhan Timesheet</strong>
  ...
  <section id="contact">
    ...
    <div class="callout info">
      <strong>Jam Operasional Tim Dukungan Teknis</strong>
